<template>
  <form @submit.prevent="submitReminder" class="space-y-6 bg-white p-8 rounded-lg shadow-lg max-w-lg mx-auto">
    <h2 class="text-2xl font-bold text-navy-blue mb-6">{{ editingReminder ? 'Editar Recordatorio' : 'Agregar Recordatorio' }}</h2>
    ...
    <div class="flex justify-between items-center mt-6">
      <button
        type="submit"
        class="bg-navy-blue text-white px-6 py-3 rounded-md hover:bg-light-blue transition-colors focus:outline-none focus:ring-2 focus:ring-light-blue"
      >
      ...
      <button
        ...
        class="bg-gray-500 text-white px-6 py-3 rounded-md hover:bg-gray-400 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400"
      >
        Cancelar
      </button>
    </div>
